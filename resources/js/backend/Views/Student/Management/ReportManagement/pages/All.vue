          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-12 col-md-2 mb-2 mb-md-0">
                ...
                <button  @click="fetchTodayMeal" class="btn btn-success btn-sm pull-right p-2">To Day Meal</button>
              </div>
              <!-- <div class="col-12 col-md-2 mb-2 mb-md-0">
                <button  @click="clearTodayMeal" class="btn btn-info btn-sm pull-right p-2">Clear Data</button>
              </div> -->
              ...
              <table class="table table-hover text-center table-bordered">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <!-- <td :class="item.quantity == 0 ? 'bg-danger text-white' : 'bg-success text-white'">
                      {{ item?.quantity ?? 'N/A' }}
                    </td> -->
...
export default {
  ...
  methods: {
    ...
    fetchTodayMeal: async function(){
      // const today = new Date().toISOString().slice(0, 10); 
      // this.mealData = this.all?.data?.filter(item => item.date === today) || [];
      // console.log('to day meal', this.mealData);

        const today = new Date().toISOString().slice(0, 10); 
        console.log('date', today);
        try {
          const response = await axios.get(`user-meals/to-day-meal/date=${today}`);
