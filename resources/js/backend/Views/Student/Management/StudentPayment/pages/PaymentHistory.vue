              ...
              <table class="table table-hover text-center table-bordered">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>
                      {{
                        items.created_at ? items.created_at.slice(0, 10) : "N/A"
                      }}
                    </td>
                  </tr>
...
export default {
  ...
  methods: {
    ...
    //       `user-payments/student-payment-history/${id}`,
    //       payload
    //     );

    //     this.item = response.data;
    //     this.total_amount = (this.item.data || []).reduce(
    ...
    //     );
    //     // if server returns 'Data not found' as a 404 with message, clear item to show 'No data found'
    //     this.item = { data: [] };
    //     this.total_amount = 0;
    //   }
    // },
    ...
    //       `user-payments/student-payment-history/${this.user_id}`,
    //       {
    ...
    paymentHistory: async function () {
      try {
        const response = await axios.get(`user-payments/student-payment-history`);
        this.item = response.data;
    ...
    filterDate: async function () {
      ...
      try {
        let response = await axios.get(`user-payments/student-payment-history`, {
          params: {
            start_date: this.start_date,
            end_date: this.end_date,
            limit: 30
