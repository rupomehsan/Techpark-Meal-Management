        ...
        <div class="card">
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <!-- Sorting Button -->
              <div class="col-12 col-md-9 text-md-right text-sm-left">
                <button
          ...
          <div class="card-body">
            ...
            >
              <table class="table table-hover text-center table-bordered">
                ...
                <tbody>
                  <tr
                    v-for="(item, index) in expense?.data"
                    :key="index"
                    :class="`table_rows table_row_${index}`"
                  >
                  <td>
                    <span
                      class="icon"
                  ...
                  <td>{{ index + 1 }}</td>
                  <td>{{ item.total_sum ?? "N/A" }} &#2547;</td>
                  <td v-if="item.cook_salary">{{ item.cook_salary }} &#2547;</td>
                  <td v-else>N/A</td>
                ...
                <!-- <tbody class="mt-4">
                  <tr>
                    <td :colspan="4">Total Bajar Cost : {{ data.total_bajar }}</td>
                  </tr>
                  <tr>
                    <td :colspan="4">Total Cook Cost : {{ total_bajar }}</td>
                  </tr>
                  <tr>
                    <td :colspan="4">Grand Total Cost : {{ total_bajar }}</td>
                  </tr>
                </tbody> -->
              </table>
            </div>
    ...
    >
      <div class="off_canvas_body">
        ...
        <div class="data_content">
          ...
          <div class="filter_item">
            <button
              @click.prevent="date_wise_expense()"
              type="button"
...
export default {
  ...
  computed: {
    ...
    isAllSelected() {
      return (
        this.expense?.data?.length > 0 &&
        this.expense.data?.every((item) =>
