          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="col-md-6 pull-left">
                ...
                <div class="mb-3">
                  <label for="mealRate" class="form-label">Meal Off Date</label>
                  <input type="date" v-model="form_fields.off_date" name="off_date" class="form-control" id="mealRate">
                </div>
              </div>
              ...
              <div class="col-md-6 pull-right">
                <div class="mb-3">
                  ...
                  <select name="meal_status" v-model="form_fields.meal_status" class="form-control" id="meal_status">
...
export default {
  ...
  methods: {
    ...
    set_fields: async function (id) {
      ...
      if (this.item) {
          this.form_fields.off_date = this.item.off_date;
